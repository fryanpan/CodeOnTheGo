 ...
 *     `./gradlew :forms-plugin:assemblePluginDebug`) and copy
 *     `forms-plugin/build/plugin/forms-plugin-debug.cgp` into
...
object PluginTestSetup {
     ...
     *
     * @param assetPath path under `androidTest/assets/`, e.g. `plugins/forms-plugin-debug.cgp`
